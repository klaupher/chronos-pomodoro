      ...
      <Container>
        <GenericHtml>
          ...
          <p>
            ...
            tempo (os famosos "Pomodoros") intercalados com pausas. O objetivo é manter o foco total
          ...
          <p>
            ...
            quiser! Basta acessar a <a href='/settings'>página de configurações</a> e ajustar os
            minutos como preferir.
          </p>

          <h3>🔁 Ciclos organizados em sequência</h3>
          <p>
            A cada ciclo completado, uma nova task é adicionada automaticamente ao seu histórico, e
            o app já sugere o próximo ciclo (foco ou descanso).
          </p>
          <p>
          ...
          <p>
            Assim, você sempre sabe em que parte do processo está e o que vem a seguir. Não precisa
            mais anotar no papel ou ficar calculando de cabeça!
          </p>

          <h3>📊 Histórico automático</h3>
          <p>
            Todas as suas tarefas e ciclos concluídos ficam salvos no{' '}
            <a href='/history'>histórico</a>, com status de completas ou interrompidas. Assim, você
          ...
          <p>
            <strong>Pronto pra focar?</strong> Bora lá <a href='/'>voltar para a página inicial</a>{' '}
